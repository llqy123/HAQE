...
# parser.add_argument(
#     "--dataset", default="WN18RR", choices=["WN18RR", "FB237", "YAGO3-10", "WN", "FB15K"],
#     help="Knowledge Graph dataset"
# )
parser.add_argument(
    "--dataset", default="WN18RR", choices=["WN18RR", "FB237", "YAGO3-10", "WN", "FB15K", "WN18RR_n-n//1-1", "WN18RR_n-n//1-n", "WN18RR_n-n//n-1", "WN18RR_n-n//n-n"],
    help="Knowledge Graph dataset"
)
parser.add_argument(
    "--model", default="HAQE", choices=all_models, help="Knowledge Graph embedding model"
)
parser.add_argument(
...
parser.add_argument(
    "--rank", default=64, type=int, help="Embedding dimension"
)
parser.add_argument(
    "--batch_size", default=500, type=int, help="Batch size"
)
parser.add_argument(

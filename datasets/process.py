...
if __name__ == "__main__":
    data_path = r"G:\hyperbolic\HyprQE代码\src_data\WN18RR_n-n"
...
# CUDA_VISIBLE_DEVICES=0 python run.py --dataset WN18RR_n-n//1-1 --rank 64 --regularizer N3 --reg 0.0 --optimizer Adam --max_epochs 300 --patience 10 --valid 5 --batch_size 1000 --neg_sample_size 200 --init_size 0.001 --learning_rate 0.001 --gamma 0.0 --bias learn --dtype single --double_neg --multi_c
#
# CUDA_VISIBLE_DEVICES=1 python run.py --dataset WN18RR_n-n//1-n --rank 64 --regularizer N3 --reg 0.0 --optimizer Adam --max_epochs 300 --patience 10 --valid 5 --batch_size 1000 --neg_sample_size 200 --init_size 0.001 --learning_rate 0.001 --gamma 0.0 --bias learn --dtype single --double_neg --multi_c
#
# CUDA_VISIBLE_DEVICES=2 python run.py --dataset WN18RR_n-n//n-1 --rank 64 --regularizer N3 --reg 0.0 --optimizer Adam --max_epochs 300 --patience 10 --valid 5 --batch_size 1000 --neg_sample_size 200 --init_size 0.001 --learning_rate 0.001 --gamma 0.0 --bias learn --dtype single --double_neg --multi_c
#
# CUDA_VISIBLE_DEVICES=4 python run.py --dataset WN18RR_n-n//n-n --rank 64 --regularizer N3 --reg 0.0 --optimizer Adam --max_epochs 300 --patience 10 --valid 5 --batch_size 1000 --neg_sample_size 200 --init_size 0.001 --learning_rate 0.001 --gamma 0.0 --bias learn --dtype single --double_neg --multi_c
#
